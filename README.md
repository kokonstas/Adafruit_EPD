This is a port of the adafruit EPD library and it's associated dependencies meant to be a portable C++ embedded library to be used with any compatible embedded port.
